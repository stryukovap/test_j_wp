...
function storm_site_scripts() {
	wp_enqueue_style( 'site-style', get_stylesheet_uri(), array(), '_bld_1556035928111' );
	wp_enqueue_script( 'site-script', get_template_directory_uri() . '/assets/js/build.js', array('jquery'), '_bld_1556035928111', true );
}
